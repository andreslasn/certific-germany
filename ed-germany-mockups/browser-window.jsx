...
function ChromeToolbar({ url = 'example.com' }) {
  ...
  return (
    <div style={{
      height: 40, boxSizing: 'border-box', background: CHROME_C.tabBg,
      display: 'flex', alignItems: 'center', gap: 4, padding: '5px 8px',
    }}>
      {iconDot}
      {/* url bar */}
      <div style={{
        flex: 1, height: 30, boxSizing: 'border-box', borderRadius: 15, background: CHROME_C.urlBg,
        display: 'flex', alignItems: 'center', gap: 8, padding: '0 14px',
        margin: '0 6px',
      }}>
        <div style={{ width: 12, height: 12, borderRadius: '50%', background: CHROME_C.dim, opacity: 0.4 }} />
        <span style={{
          flex: 1, color: CHROME_C.text, fontSize: 13, lineHeight: 1,
